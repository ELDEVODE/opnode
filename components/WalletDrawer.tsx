          ...
          <div className="relative mb-6 overflow-hidden rounded-[32px] bg-[#15151A] p-6 border border-white/5">
            ...
            {userProfile?.bolt12Offer && (
              <button
                ...
                className="mb-8 w-full flex items-center justify-between gap-3 rounded-2xl bg-[#1A1A1F] p-4 border border-white/10 hover:border-white/20 transition group"
              >
                ...
                {copied ? (
                  ...
                  <IoCopyOutline className="h-5 w-5 text-white/40 flex-shrink-0 group-hover:text-white/60 transition" />
                )}
              </button>
            )}
